...
class PassageSeeder extends Seeder
{
    public function run(): void
    {
        $passages = [
            ...
            // ── N2 文法読解 additional passages ──────────────────────────────────
            [
                'level' => 'N2',
                'title' => '[文法読解-もんだい３-3] 少子高齢化の影響',
                'content' => "日本では少子高齢化が急速に Ⓐ 進んでおり、労働力不足や社会保障費の増大が深刻な課題となっています。この問題に Ⓑ 対処するために、政府や企業はさまざまな取り組みを進めています。",
            ],
            [
                'level' => 'N2',
                'title' => '[文法読解-もんだい４-2] ストレス管理の重要性',
                'content' => "現代社会では、仕事や人間関係などによるストレスが増加しており、健康への影響が懸念されています。専門家によると、ストレスを完全になくすことは難しいものの、適切に管理することで心身への悪影響を軽減できるとされています。\n\n効果的なストレス管理の方法として、適度な運動、十分な睡眠、趣味の時間を設けることが挙げられます。また、信頼できる人に話を聞いてもらうことも、精神的な健康を保つ上で重要です。",
            ],
            [
                'level' => 'N2',
                'title' => '[文法読解-もんだい４-3] 食品ロス削減への取り組み',
                'content' => "日本では、年間約600万トンもの食品が廃棄されているとされており、これは世界全体の食料援助量の約1.5倍に相当します。この「食品ロス」を削減するため、企業や消費者の双方が取り組みを強化しています。\n\n食品メーカーや小売業者は、製造から販売、消費に至るまでのプロセス全体を見直し、廃棄される食品の量を減らす努力をしています。消費者側でも、必要な分だけ買い、期限の近い商品から使うといった工夫が求められています。",
            ],
            [
                'level' => 'N2',
                'title' => '[文法読解-もんだい５-2] 観光業の復活と課題',
                'content' => "新型コロナウイルスの感染拡大によって大きな打撃を受けた観光業は、制限の緩和とともに回復の兆しを見せています。国内外の旅行者が増加し、観光地はかつての活気を取り戻しつつあります。\n\nしかし、回復の恩恵が均等に行き届いているわけではありません。有名観光地では「オーバーツーリズム」と呼ばれる過剰な観光客の集中が問題となっており、地域住民の生活や自然環境への影響が懸念されています。一方、地方の小規模な観光地では、依然として集客に苦しんでいるところも少なくありません。\n\nこのような課題に対し、各地域では観光客を分散させるための施策や、持続可能な観光の在り方を模索する動きが広がっています。また、デジタル技術を活用した観光体験の提供や、地域の文化・食・自然を深く体験できる「体験型観光」への転換も進んでいます。",
            ],
            [
                'level' => 'N2',
                'title' => '[文法読解-もんだい６-2] 区立スポーツセンター利用案内',
                'content' => "○○区立スポーツセンター　利用案内\n\n【施設・料金】\n・トレーニングルーム：一般500円　高校生200円　中学生以下100円\n・プール（25m）：一般700円　高校生400円　中学生以下200円\n・体育館（バドミントン・卓球等）：1面1時間500円（予約制）\n\n【営業時間】午前9時〜午後9時（最終受付午後8時30分）\n【休館日】毎週月曜日・年末年始（12月29日〜1月3日）\n\n【注意事項】\n・体育館はウェブサイトまたは電話にて事前予約が必要です\n・トレーニングルームの初回利用時は、無料オリエンテーション（約30分）への参加が必須です\n・中学生以下のプール利用は保護者同伴が必要です",
            ],
