      ...
      <form onSubmit={handleSubmit} className="w-full max-w-2xl rounded-xl border border-gray-200 bg-white p-6 shadow-sm md:p-8">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label className="block text-sm font-medium text-gray-700">{t('admin.userForm.name')}</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">{t('admin.userForm.email')}</label>
              <input
                type="email"
                required
                value={email}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">
              ...
              {isEdit && <span className="ml-1 text-xs font-normal text-gray-400">({t('admin.userForm.passwordOptional')})</span>}
            </label>
            <input
              type="password"
              required={!isEdit}
